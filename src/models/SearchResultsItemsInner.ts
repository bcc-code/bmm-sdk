...
/**
 * @type SearchResultsItemsInner
 * 
 * @export
 */
export type SearchResultsItemsInner = { type: 'album' } & AlbumModel | { type: 'contributor' } & ContributorModel | { type: 'playlist' } & PlaylistModel | { type: 'podcast' } & PodcastModel | { type: 'track' } & TrackModel;

export function SearchResultsItemsInnerFromJSON(json: any): SearchResultsItemsInner {
    return SearchResultsItemsInnerFromJSONTyped(json, false);
}

export function SearchResultsItemsInnerFromJSONTyped(json: any, ignoreDiscriminator: boolean): SearchResultsItemsInner {
    ...
    switch (json['type']) {
        ...
        default:
            throw new Error(`No variant of SearchResultsItemsInner exists with 'type=${json['type']}'`);
    }
}

export function SearchResultsItemsInnerToJSON(value?: SearchResultsItemsInner | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    switch (value['type']) {
        ...
        default:
            throw new Error(`No variant of SearchResultsItemsInner exists with 'type=${value['type']}'`);
    }
